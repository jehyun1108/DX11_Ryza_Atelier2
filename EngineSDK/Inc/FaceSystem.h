...
public:
    ...
    Handle   Create(EntityID owner, Handle anim, wstring openClip, wstring closeClip,  float openDur = 2.5f, float openJitter = 1.2f, float holdClose = 0.12f, float fadeClose = 0.08f, float fadeOpen = 0.08f);
